...
int main(int argc, char** argv){
  ...
  move_base_msgs::MoveBaseGoal pickup_goal  = setGoal(-1,1 , 0.679776960744, 0.733418900521);
  move_base_msgs::MoveBaseGoal dropoff_goal = setGoal(1,1, 0.703485544441, 0.710709567096);
